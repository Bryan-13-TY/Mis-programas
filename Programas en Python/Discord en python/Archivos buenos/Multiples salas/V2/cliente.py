    ...
    def enviar_mensaje(self) -> None:
        ...
        while (self.activo):
            try:
                ...
                # ---- El usuario envía un audio público ----
                ...
                # ---- El usuario envía un sticker público ----
                ...
                # ---- Mensajes privados ----
                    ...
                    # ---- El usuario envía un sticker privado
                    ...
                    # ---- El usuario envía un audio privado ----
                    elif (partes[1] == "/audio"):
                        destinatario, _ = partes
                        destinatario = destinatario[1:] # Quitar '@'
                    ...
                    # ---- El usuario envía un mensaje privado
                    else:
                ...
                # ---- El usuario envía un mensaje público
                else:
                    mensaje = {"tipo": "msj",
                               "privado": False,
                               "user": self.usuario,
...
def main() -> None:
    print(">> [system] Obteniendo salas disponibles...\n")
    ...
    if (salas_disponibles):
        ...
        print(">> [system] No hay salas actvas. Se creará una nueva sala al unirte")
