...
def obtenerRuta() -> str:
    ...
    rutaJSON = os.path.join(carpetaScript, "articulos.json") # Construye la ruta completa hacia "articulos.json"
...
def guardarArticulos(rutaArticulos: str) -> dict:
    """
    Convierte los artículos del archivo "Articulos.json" a un diccionario.
    ...
    -------
    dict
        Diccionario con los artículos guardados del archivo "Articulos.json".
    """
